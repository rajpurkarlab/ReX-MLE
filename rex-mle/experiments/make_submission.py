...
from rexmle.utils import get_logger
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Makes a submission.jsonl for rexmle grade from a rexmle run group"
    )
    ...
    parser.add_argument(
        "--output",
        type=str,
        help="Path to the output jsonl file which can be used for `rexmle grade`",
