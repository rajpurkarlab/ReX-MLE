"""
Data preparation script for PUMA Track 1 Task 2 - Nuclei Detection (3 Classes)
...
def prepare(raw: Path, public: Path, private: Path) -> None:
    """
    Prepare PUMA Track 1 Task 2 data (Nuclei Detection - 3 Classes).
    ...
    """
    print(f"Preparing PUMA Track 1 Task 2 (Nuclei Detection - 3 Classes)...")
    print(f"  Raw: {raw}")
    ...
    for case in test_cases:
        ...
        convert_nuclei_geojson_to_json(geojson_path, json_path, class_mapping_track1)
    ...
    # Create README
    readme = f"""# PUMA Track 1 Task 2: Nuclei Detection (3 Classes)
...
## Task: Nuclei Detection (3 Classes)

Detect and classify nuclei into three broad categories:

1. **Tumor**: Melanoma tumor cell nuclei
2. **TILs**: Tumor-infiltrating lymphocytes (lymphocytes + plasma cells)
3. **Other**: All other cell types (histiocytes, melanophages, neutrophils, stromal cells, epithelium, endothelium, apoptotic cells)
