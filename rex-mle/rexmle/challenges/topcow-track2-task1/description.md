...
TopCoW Track 2 Task 1 focuses on multi-class segmentation of the Circle of Willis vessels using MRA (Magnetic Resonance Angiography) imaging. The goal is to accurately segment individual vessels of this critical cerebrovascular structure.

## Task Description

**Objective:** Segment individual vessels of the Circle of Willis into multiple anatomical classes on MRA images.
...
### Training Data
- **125 MRA cases** with multi-class segmentation annotations
