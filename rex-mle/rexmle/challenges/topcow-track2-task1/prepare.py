"""
Data preparation script for TopCoW Track 2 Task 1 - MRA Multi-class Segmentation
...
def prepare(raw: Path, public: Path, private: Path) -> None:
    """
    Prepare TopCoW Track 2 Task 1 data (MRA Segmentation).

    Expected structure in raw/:
    - imagesTr/: CTA and MRA training images
    - cow_seg_labelsTr/: Segmentation masks
    """
    print(f"Preparing TopCoW Track 2 Task 1 (MRA Segmentation)...")
    print(f"  Raw: {raw}")
    ...
    # Create README
    readme = f"""# TopCoW Track 2 Task 1: MRA Multi-class Segmentation
...
- Labels: `topcow_mr_{{pat_id}}_0000.nii.gz` (multi-class segmentation)
