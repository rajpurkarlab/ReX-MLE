...
class DSCoderCoSTEERSettings(CoSTEERSettings):
    ...
    env_type: str = "docker"
    env_conda_env: str = "agent"  # Conda environment name for conda mode
